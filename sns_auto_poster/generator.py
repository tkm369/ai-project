...
- 「SOS」「限界」「緊急」「警告」「危険」など不安を強く煽る言葉を使わない
- 「なぜ私だけ」「私なんて」など自己否定を過度に煽る表現を使わない
- 📣🚫⚠️🆘など警告・緊急系の絵文字を使わない
- 感情的に追い詰めるような書き方をしない（不安を煽るのではなく、寄り添うトーンに）
...
- 「SOS」「限界」「緊急」「警告」など不安を強く煽る言葉を使わない
- 📣🚫⚠️🆘など警告系絵文字を使わない / 感情的に追い詰めるトーンにしない
